                            ...
                            <div className="bg-gradient-to-br from-blue-900/40 to-cyan-900/40 backdrop-blur-sm border-2 border-cyan-400 rounded-2xl p-8 shadow-2xl hover:shadow-cyan-500/40 transition-all duration-300">
                                ...
                                <ul className="space-y-3 text-gray-300">
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            Connect your wallet and select your
                                            NFT
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            Choose how many fractional tokens to
                                            create
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            Receive all fractional tokens to
                                            your wallet
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                            ...
                            <div className="bg-gradient-to-br from-purple-900/40 to-pink-900/40 backdrop-blur-sm border-2 border-purple-400 rounded-2xl p-8 shadow-2xl hover:shadow-purple-500/40 transition-all duration-300">
                                ...
                                <ul className="space-y-3 text-gray-300">
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            Browse fractionalized NFTs in the
                                            marketplace
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            Buy fractional tokens starting from
                                            $1
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            Diversify across multiple premium
                                            assets
                                        </span>
                                    </li>
                                    <li className="flex items-start">
                                        ...
                                        <span>
                                            Trade fractions instantly on the
                                            marketplace
                                        </span>
                                    </li>
                                </ul>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="text-center">
                                ...
                                <p className="text-sm text-gray-400">
                                    Access premium NFTs worth $100k+ with just a
                                    few dollars
                                </p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-sm text-gray-400">
                                    Build a portfolio across multiple
                                    collections instead of one NFT
                                </p>
                            </div>
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-sm text-gray-400">
                                    Trade fractions in seconds vs. weeks for
                                    whole NFTs
                                </p>
                            </div>
                        </div>
